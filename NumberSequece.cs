...
namespace ConsoleApp2
{
    class NumberSequence { 
        ...
        public NumberSequence(int sequenceSize, SortStrategy sortStrategy) 
        { 
        ...
        public NumberSequence(double[] array, SortStrategy sortStrategy) : this(array.Length, sortStrategy) 
